...
all_data <- all_data %>%
  mutate(b_bhs_sum = b_bhs_1 + b_bhs_2 + b_bhs_3 + b_bhs_4, 
        ...
        b_edeq_dietary_restraint = b_edeq_1 + b_edeq_2 + b_edeq_3,
        ...
        f_edeq_dietary_restraint = f_edeq_1 + f_edeq_2 + f_edeq_3,
        f_edeq_body_dissatisfaction = f_edeq_4 + f_edeq_5 + f_edeq_6,
        f_edeq_overvaluation = f_edeq_7 + f_edeq_8 + f_edeq_9 + f_edeq_10,
